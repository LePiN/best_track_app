...
from desafio_sbtur.showcase_selector_api.showcase_views import ShowcaseViewSet, PageRouterViewSet
from desafio_sbtur.hotel_selector_api.hotel_views import HotelViewSet, CategoryViewSet
from desafio_sbtur.location_selector_api.location_views import (
    CityViewSet,
    CountryViewSet,
)
